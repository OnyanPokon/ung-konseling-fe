...
const Home = () => {
  ...
  return (
    <>
      <section
        style={{
          backgroundImage: "url('/image_asset/hero_background.png')",
      ...
      >
        <div className="mx-auto grid min-h-screen w-full max-w-screen-xl grid-cols-6 items-center gap-x-10 px-6 py-28">
          <div className="col-span-6 flex w-full flex-col gap-y-4 lg:col-span-3">
            <div className="flex flex-col gap-y-4">
              <strong className="text-2xl text-white">
                <Reveal>Selamat Datang di</Reveal>
              </strong>
              <Typography.Title style={{ maring: 0, color: '#fff' }}>
